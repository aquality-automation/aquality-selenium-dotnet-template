...
namespace Aquality.Selenium.Template.Forms
{
    ...
    {
        private readonly IDictionary<Item, string> menuItems = new Dictionary<Item, string>
        {
        ...
        {
            ElementFactory.GetButton(By.XPath(menuItems[menuItem]), menuItem.ToString()).ClickAndWait();
        }
